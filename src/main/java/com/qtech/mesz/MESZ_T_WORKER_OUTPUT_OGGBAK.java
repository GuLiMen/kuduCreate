...
public class MESZ_T_WORKER_OUTPUT_OGGBAK {
...
//        kuduMaster = "dev02";
        kuduTable = "MESZ_T_WORKER_OUTPUT_OGGBAK";         //指定表名
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("XM",Type.STRING).nullable(true).build());
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("OUTTYPE",Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("OUTPUT",Type.STRING).nullable(true).build());
