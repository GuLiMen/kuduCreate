...
public class ADS_ANGLE_RT_DATA_BAK {
...
//        kuduMaster = "dev02";
        kuduTable = "ADS_ANGLE_RT_DATA_BAK_TEST";         //指定表名
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("EQUIPMENTID", Type.STRING).key(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("MCID",Type.STRING).key(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("DATETIME",Type.STRING).key(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("CODE",Type.INT32).nullable(true).build());
                ...
                //根据字段id分区
                partitionList.add("EQUIPMENTID");
                partitionList.add("MCID");
                partitionList.add("DATETIME");
                //设置表的Hash分区
