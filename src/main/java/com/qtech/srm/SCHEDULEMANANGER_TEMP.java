...
public class SCHEDULEMANANGER_TEMP {
...
//        kuduMaster = "dev02";
        kuduTable = "SRM_SCHEDULEMANANGER_TEMP";         //指定表名
    ...
    public void creatTable(){
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)){
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("COMPANYCODE",Type.STRING).nullable(true).build());
