...
public class IQC_SUPPLIERRELATION {
...
//        kuduMaster = "dev02";
        kuduTable = "IQC_SUPPLIERRELATION";         //指定表名
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("IMATERIALTYPE",Type.STRING).nullable(true).build());

                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("SUPPLIER",Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("ISUPPLIER",Type.STRING).nullable(true).build());
