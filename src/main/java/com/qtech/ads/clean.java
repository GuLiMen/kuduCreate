...
public class clean {
    ...
    public void init() {                //初始化操作
        ...
        kuduTable = "MESC_TEST_MOD_DATA_DETAIL";         //指定表名
    ...
    public void renameTable(){
        try {
            kuduClient.alterTable(kuduTable,
                    new AlterTableOptions().renameTable("MESC_TEST_MOD_DATA_DETAIL"));
        } catch (KuduException e) {
            e.printStackTrace();
        }
    }
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                //设置表的Hash分区
                Options.addHashPartitions(partitionList, 10);
                ...
                String[] keys = new String[]{"2021-07-01","2021-07-15","2021-08-01","2021-08" +
                        "-15","2021-09-01","2021-09-15","2021-10-01","2021-10" +
                        "-15"};
                for (String key : keys) {
