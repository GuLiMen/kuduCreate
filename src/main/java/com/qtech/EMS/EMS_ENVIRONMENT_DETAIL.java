...
public class EMS_ENVIRONMENT_DETAIL {
...
//        kuduMaster = "dev02";
        kuduTable = "EMS_ENVIRONMENT_DETAIL";         //指定表名
    ...
    public void creatTable(){
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)){
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("TEMPERATURE_VALUE",Type.DOUBLE).nullable(true).comment("温度的数值").build());
