...
public class erp_v_12190383_sojk071 {
...
//        kuduMaster = "dev02";
        kuduTable = "ERP_V_12190383_SOJK071";         //指定表名
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("BMBA001A",Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("BMBA001B",Type.STRING).nullable(true).build());
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("INAG008_F",Type.DOUBLE).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("WIP_F",Type.DOUBLE).nullable(true).build());
