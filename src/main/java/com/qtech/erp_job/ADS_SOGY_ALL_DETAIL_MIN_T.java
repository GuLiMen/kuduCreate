...
public class ADS_SOGY_ALL_DETAIL_MIN_T {
    ...
    public void init() {                //初始化操作
        ...
        kuduTable = "ADS_SOGY_ALL_DETAIL_MIN_T";         //指定表名
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("MINQT",Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("MINQT02",Type.STRING).nullable(true).build());
