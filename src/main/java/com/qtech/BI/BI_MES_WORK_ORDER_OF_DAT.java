...
public class BI_MES_WORK_ORDER_OF_DAT {
...
//        kuduMaster = "dev02";
        kuduTable = "BI_MES_WORK_ORDER_OF_DAT";         //指定表名
    ...
    public void creatTable(){
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)){
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("QTY",Type.INT32).nullable(true).build());
