...
public class BI_ZHZL_SUBMIT_CHEKLIST {
...
//        kuduMaster = "dev02";
        kuduTable = "BI_ZHZL_SUBMIT_CHEKLIST";         //指定表名
    ...
    public void creatTable () {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("DUTY", Type.STRING).nullable(true).build());
