...
public class ADS_AA_STATE_LIST {
...
//        kuduMaster = "dev02";
        kuduTable = "ADS_AA_STATE_LIST";         //指定表名
    ...
    public void creatTable () {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("CREATAE_TIME", Type.STRING).key(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("FACTORY_NAME", Type.STRING).nullable(true).build());
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("DEVICE_E_ID", Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("LOT_FILE_NAME", Type.STRING).nullable(true).build());
