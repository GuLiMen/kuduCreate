    ...
    public void renameTable(){
        try {
            kuduClient.alterTable(kuduTable,
                    new AlterTableOptions().renameTable("MESC_B_REWORKNO2SN"));
        } catch (KuduException e) {
            e.printStackTrace();
        }
    }
    ...
    public void creatTable(){
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)){
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("REWORK_NO",Type.STRING).key(true).build());
