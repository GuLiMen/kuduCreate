...
public class MESC_TEST_SNCODE_CHECKRESULT {
...
//        kuduMaster = "dev02";
        kuduTable = "MESC_TEST_SNCODE_CHECKRESULT";         //指定表名
    ...
    public void creatTable() {
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)) {
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("SNCODE",Type.STRING).nullable(true).build());
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("TESTTIME",Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("TESTRESULT",Type.STRING).nullable(true).build());
