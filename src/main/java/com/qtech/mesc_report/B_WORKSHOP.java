    ...
    public void renameTable(){
        try {
            kuduClient.alterTable(kuduTable,
                    new AlterTableOptions().renameTable("MESC_B_WORKSHOP"));
        } catch (KuduException e) {
            e.printStackTrace();
        }
    }
    ...
    public void creatTable(){
        ...
        try {
            ...
            if (!kuduClient.tableExists(kuduTable)){
                ...
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("WORKSHOP_NAME",Type.STRING).nullable(true).build());
                columnSchemas.add(new ColumnSchema.ColumnSchemaBuilder("PLANT_CODE",Type.STRING).nullable(true).build());
